...
* [*知识点2: 顺序容器类型概述*](#id2)：六种顺序容器的基本介绍
    ...
    * [*知识点2.4: forward_list容器特点(c++11)*](#id6)：单向链表的性能特点
    * [*知识点2.5: array容器特点(c++11)*](#id7)：固定大小数组的特点
* [*知识点3: 容器选择指南*](#id14)：如何根据需求选择合适的顺序容器
    * [*知识点5.1: 默认选择规则*](#id15)：优先使用vector的原则
    * [*知识点5.2: 空间考虑规则*](#id16)：小元素情况下的容器选择
    * [*知识点5.3: 访问模式规则*](#id17)：随机访问需求的容器选择
    * [*知识点5.4: 插入删除规则*](#id18)：不同位置操作的容器选择
    * [*知识点5.5: 输入处理策略*](#id19)：输入阶段的容器使用策略
    * [*知识点5.6: 复杂场景决策*](#id20)：多重需求下的容器选择方法
    * [*知识点6: 最佳实践建议*](#id21)：编写通用代码的最佳实践
